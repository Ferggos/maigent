...
struct HostRawState {
  ...
  double psi_cpu_some_avg60 = 0.0;
  double psi_mem_some_avg60 = 0.0;
  double psi_io_some_avg60 = 0.0;
  double psi_mem_full_avg10 = 0.0;
  double psi_mem_full_avg60 = 0.0;
  double psi_io_full_avg10 = 0.0;
  double psi_io_full_avg60 = 0.0;
};
...
class HostRawCollector {
 ...
 private:
  ...
  double ReadPressureAvg(const char* path, const char* line_prefix,
